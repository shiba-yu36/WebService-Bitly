# This Makefile is for the WebService::Bitly extension to perl.
#
...
#     ABSTRACT => q[The great new WebService::Bitly!]
#     AUTHOR => q[Yuki Shibazaki <shiba1029196473@gmail.com>]
#     DIR => []
#     DISTNAME => q[WebService-Bitly]
#     LICENSE => q[gpl]
#     NAME => q[WebService::Bitly]
#     NO_META => q[1]
#     PREREQ_PM => { ExtUtils::MakeMaker=>q[6.42] }
#     VERSION => q[0.01]
#     dist => { PREOP=>q[$(PERL) -I. "-MModule::Install::Admin" -e "dist_preop(q($(DISTVNAME)))"] }
#     realclean => { FILES=>q[MYMETA.yml] }
#     test => { TESTS=>q[t/00-load.t t/02-function.t t/boilerplate.t t/manifest.t t/pod-coverage.t t/pod.t] }
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/WebService/Bitly.pm
...
TO_INST_PM = lib/WebService/Bitly.pm \
	lib/WebService/Bitly/Entry.pm \
	lib/WebService/Bitly/Result.pm \
	lib/WebService/Bitly/Result/Authenticate.pm \
	lib/WebService/Bitly/Result/BitlyProDomain.pm \
	lib/WebService/Bitly/Result/Clicks.pm \
	lib/WebService/Bitly/Result/Expand.pm \
	lib/WebService/Bitly/Result/HTTPError.pm \
	lib/WebService/Bitly/Result/Info.pm \
	lib/WebService/Bitly/Result/Lookup.pm \
	lib/WebService/Bitly/Result/Shorten.pm \
	lib/WebService/Bitly/Result/Validate.pm

PM_TO_BLIB = lib/WebService/Bitly/Result/Info.pm \
	blib/lib/WebService/Bitly/Result/Info.pm \
	lib/WebService/Bitly/Result/Authenticate.pm \
	blib/lib/WebService/Bitly/Result/Authenticate.pm \
	lib/WebService/Bitly/Result/Clicks.pm \
	blib/lib/WebService/Bitly/Result/Clicks.pm \
	lib/WebService/Bitly/Result/Shorten.pm \
	blib/lib/WebService/Bitly/Result/Shorten.pm \
	lib/WebService/Bitly/Result/Lookup.pm \
...
DISTNAME = WebService-Bitly
DISTVNAME = WebService-Bitly-0.01
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/WebService/Bitly.pm $(INST_MAN3DIR)/WebService::Bitly.$(MAN3EXT) 
...
TEST_FILE = test.pl
TEST_FILES = t/00-load.t t/02-function.t t/boilerplate.t t/manifest.t t/pod-coverage.t t/pod.t
TESTDB_SW = -d
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>The great new WebService::Bitly!</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Yuki Shibazaki &lt;shiba1029196473@gmail.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/WebService/Bitly/Result/Info.pm blib/lib/WebService/Bitly/Result/Info.pm \
	  lib/WebService/Bitly/Result/Authenticate.pm blib/lib/WebService/Bitly/Result/Authenticate.pm \
	  lib/WebService/Bitly/Result/Clicks.pm blib/lib/WebService/Bitly/Result/Clicks.pm \
	  lib/WebService/Bitly/Result/Shorten.pm blib/lib/WebService/Bitly/Result/Shorten.pm \
	  lib/WebService/Bitly/Result/Lookup.pm blib/lib/WebService/Bitly/Result/Lookup.pm \
	  lib/WebService/Bitly/Result.pm blib/lib/WebService/Bitly/Result.pm \
	  lib/WebService/Bitly/Result/Validate.pm blib/lib/WebService/Bitly/Result/Validate.pm \
	  lib/WebService/Bitly/Result/BitlyProDomain.pm blib/lib/WebService/Bitly/Result/BitlyProDomain.pm \
	  lib/WebService/Bitly/Entry.pm blib/lib/WebService/Bitly/Entry.pm \
	  lib/WebService/Bitly/Result/Expand.pm blib/lib/WebService/Bitly/Result/Expand.pm \
	  lib/WebService/Bitly/Result/HTTPError.pm blib/lib/WebService/Bitly/Result/HTTPError.pm \
	  lib/WebService/Bitly.pm blib/lib/WebService/Bitly.pm 
